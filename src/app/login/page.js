...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    if (res.ok) {
      ...
      setTimeout(() => router.push("/home"), 1200); // redirect after 1.2s
    } else {
    ...
    >
      ...
      >
        <input
          ...
          style={{ padding: "12px 15px", marginBottom: "15px", borderRadius: "8px", border: "1px solid #ccc", fontSize: "1rem" }}
        />
        <input
          type="password"
          ...
          style={{ padding: "12px 15px", marginBottom: "20px", borderRadius: "8px", border: "1px solid #ccc", fontSize: "1rem" }}
        />
        <button
          onClick={handleLogin}
          style={{
        ...
        <p style={{ marginTop: "20px", textAlign: "center", fontSize: "0.9rem", color: "#666" }}>
          ...
          <span onClick={() => router.push("/register")} style={{ color: "#11998e", cursor: "pointer", textDecoration: "underline" }}>
            Register here
          </span>
        </p>
      </div>
